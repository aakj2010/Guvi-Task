...
let resp = await fetch("https://restcountries.com/v3.1/name/Albania");
let resp1 = await resp.json();
console.log(resp1);

let titl1 = resp1[0].name.common;
console.log(titl1);

let lat1 = resp1[0].latlng[0];
console.log(lat1);
let lan1 = resp1[0].latlng[1];
console.log(lan1);

 let capital1 = resp1[0].capital;
 console.log(capital1);

 let region1 = resp1[0].region;
 console.log(region1);

 let fl1 = resp1[0].flags.svg;
 console.log(fl1);

 let cc1 = resp1[0].car.signs;
 console.log(cc1);
...
let respo = await fetch(`https://restcountries.com/v3.1/name/uk`);
let respo1 = await respo.json();
console.log(respo1);

let titl2 = respo1[0].name.common;
console.log(titl2);

let lat2 = respo1[0].latlng[0];
console.log(lat2);
let lan2 = respo1[0].latlng[1];
console.log(lan2);

 let capital2 = respo1[0].capital;
 console.log(capital2);
 let region2 = respo1[0].region;
 console.log(region2);

 let fl2 = respo1[0].flags.svg;
 console.log(fl2);

 let cc2 = respo1[0].car.signs;
 console.log(cc2);
