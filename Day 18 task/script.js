async function getWeatherData() {
    ...
    let titl1 = res1[1].name.common;
    let lat1 = res1[1].latlng[0];
    let lan1 = res1[1].latlng[1];
    let capital1 = res1[1].capital;
    let region1 = res1[1].region;
    let fl1 = res1[1].flags.svg;
    let cc1 = res1[1].car.signs;
    ...
    let titl2 = res1[2].name.common;
    let lat2 = res1[2].latlng[0];
    let lan2 = res1[2].latlng[1];
    let capital2 = res1[2].capital;
    let region2 = res1[2].region;
    let fl2 = res1[2].flags.svg;
    let cc2 = res1[2].car.signs;
